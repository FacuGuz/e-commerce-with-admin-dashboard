...
INSERT INTO app_user (username, password, email, fullname, phone_number, address, role, created_at) VALUES
                                                                       ('johndoe', 'hashed_password_1', 'john.doe@example.com', 'John Doe', '+1234567890', '123 Main St, City, State', 'ROLE_ADMIN', NOW()),
                                                                       ('janesmith', 'hashed_password_2', 'jane.smith@example.com', 'Jane Smith', '+0987654321', '456 Oak Ave, Town, State', 'ROLE_USER', NOW());

-- Insert data into `category`
INSERT INTO category (name, description) VALUES 
    ('Electronics', 'Electronic devices and gadgets'),
    ('Apparel', 'Clothing and fashion items'),
    ('Home Goods', 'Home and kitchen products');
